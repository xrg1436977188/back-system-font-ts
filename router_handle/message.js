...
exports.searchMessageBydepartment = (req, res) => {
    const sql = 'select * from message where message_category = "公司公告" and message_publish_department = ? and message_status = "0"'
...
exports.searchMessageByLevel = (req, res) => {
    const sql = 'select * from message where message_category = "公司公告" and message_level = ? and message_status = "0"'
...
exports.getMessage = (req, res) => {
    const sql = 'select * from message where message_category = ?'
